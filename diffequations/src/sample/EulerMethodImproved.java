...
public class EulerMethodImproved extends NumericalMethod {
    ...
    ArrayList<XYChart.Series> calculate(double x0, double y0, double X, int N, int evol) {
        ...
        for (int i = 0; i < steps; i++) {
            ...
            double k2 = originalEquation.getValue(tPrev + stepSize, yPrev + stepSize * k1, x0, y0);
            double yNext = yPrev + stepSize * (k1 + k2) / 2;
